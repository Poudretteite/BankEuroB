...
public class KlikServiceClient {
    ...
    public KlikPaymentStatusResponse getPaymentStatus(String transactionId) {
        ...
        try {
            ...
            ResponseEntity<KlikPaymentStatusResponse> response = restTemplate.exchange(
                    url, HttpMethod.GET, entity, KlikPaymentStatusResponse.class);
    ...
    public KlikLookupAliasResponse lookupAlias(String phone) {
        ...
        try {
            ...
            HttpEntity<Void> entity = new HttpEntity<>(buildHeaders());
            ResponseEntity<KlikLookupAliasResponse> response = restTemplate.exchange(
                    url, HttpMethod.GET, entity, KlikLookupAliasResponse.class);
